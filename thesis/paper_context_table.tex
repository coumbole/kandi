\captionof{table}{Contextual information from primary studies}\label{contextualinfotable}

\begin{center}
\begin{tabular}{p{3em} l l l l p{6em}}
    ...
    4 & Samsung & 100+ & Waterfall & Scrum & top-down \\
